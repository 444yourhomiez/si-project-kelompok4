                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">
                                        Akumulasi seluruh cicilan pinjaman khusus anggota
                                    </small>
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="mb-3 mb-md-0">
                            ...
                            <h4 class="font-weight-bold mb-1">
                                ...
                                <i class="nav-icon fas fa-money-bill-wave mr-2"></i>
                                Riwayat Cicilan Pinjaman Khusus

                            </h4>

                            <small class="text-muted">
                                Data transaksi cicilan pinjaman khusus anggota koperasi
                            </small>
        ...
        {{-- <script>
            document.addEventListener('livewire:init', () => {
                ...
                Livewire.on('closeCreateModal', () => {
                    ...
                    Swal.fire({
                        title: "Sukses",
                        text: "cicilan Khusus Berhasil Ditambah",
                        icon: "primary",
        ...
        {{-- <script>
            document.addEventListener('livewire:init', () => {
                ...
                Livewire.on('closeEditModal', () => {
                    ...
                    Swal.fire({
                        title: "Sukses",
                        text: "cicilan Khusus Berhasil Diperbarui",
                        icon: "primary",
                        confirmButtonText: "OK"
                    });
