<div>
    ...
    <div class="content-wrapper">
                    ...
                    <div class="col-sm-6">
                        ...
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">
                                ...
                                <a href="{{ route('anggota.cicilan.index') }}" class="text-muted breadcrumb-green">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    ...
                                    <div class="card-label mb-2">
                                        Total Cicilan Pinjaman Pribadi
                                    </div>
                                    ...
                                    <small class="text-muted">
                                        Akumulasi seluruh cicilan pinjaman Pribadi anggota
                                    </small>
            ...
            <div class="card table-modern border-0 shadow-sm">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="mb-3 mb-md-0">
                            ...
                            <h4 class="font-weight-bold mb-1">
                                ...
                                <i class="nav-icon fas fa-money-bill-wave mr-2"></i>
                                Riwayat Cicilan Pinjaman Pribadi

                            </h4>

                            <small class="text-muted">
                                Data transaksi cicilan pinjaman Pribadi anggota koperasi
                            </small>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-modern-list mb-0">
                        ...
                        {{-- @forelse ($cicilanPribadi as $item) --}}
                        {{-- <tr> --}}
                        ...
                        {{-- <tr>
                                    ...
                                    <td colspan="3" class="text-center py-5">
                                        ...
                                        <div class="empty-state">
                                            ...
                                            <h5>
                                                Belum ada data cicilan Pribadi
                                            </h5>

                                            <p>
                                                Data cicilan Pribadi akan tampil di sini
                                            </p>
        ...
        {{-- CREATE MODAL --}}
        {{-- @livewire('anggota.simpanan.create') --}}
        ...
        {{-- <script>
            document.addEventListener('livewire:init', () => {
                ...
                Livewire.on('closeCreateModal', () => {
                    ...
                    Swal.fire({
                        title: "Sukses",
                        text: "cicilan Pribadi Berhasil Ditambah",
                        icon: "success",
        ...
        {{-- EDIT MODAL --}}
        {{-- @livewire('anggota.simpanan.edit') --}}
        ...
        {{-- <script>
            document.addEventListener('livewire:init', () => {
                ...
                Livewire.on('closeEditModal', () => {
                    ...
                    $('#editModalcicilan').modal('hide');

                    Swal.fire({
                        title: "Sukses",
                        text: "cicilan Pribadi Berhasil Diperbarui",
                        icon: "success",
                        confirmButtonText: "OK"
                    });
