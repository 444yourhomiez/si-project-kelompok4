                    ...
                    <div>
                        ...
                        <ol class="breadcrumb p-0 bg-transparent mb-0" style="font-size:0.85rem;">
                            <li class="breadcrumb-item">
                                <a href="{{ route('manajemen.dashboard') }}" class="text-muted breadcrumb-green">Dashboard</a>
                            </li>
                            <li class="breadcrumb-item">
                                <a href="{{ route('manajemen.anggota.disetujui') }}" class="text-muted breadcrumb-green">Anggota Disetujui</a>
                            </li>
                            <li class="breadcrumb-item active text-success">Detail</li>
                        </ol>
                    </div>
                    <a href="{{ route('manajemen.anggota.disetujui') }}" class="btn btn-light shadow-sm">
                                                        ...
                                                        @foreach($pinjaman->cicilan as $cicilan)
                                                            ...
                                                            <tr class="{{ $isLate ? 'table-danger' : ($cicilan->status == 'lunas' ? 'table-success' : '') }}"
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <small class="text-muted">{{ $jatuhTempo->diffForHumans() }}</small>
                                                                </td>
