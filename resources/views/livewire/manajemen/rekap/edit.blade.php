<div>
    <div class="modal fade" wire:ignore.self id="editRekapModal" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-header bg-white">
                    <div>
                        <h5 class="modal-title font-weight-bold mb-1">
                            ...
                            Edit Rekapitulasi Harian
                        </h5>
                        <small class="text-muted">Ubah data transaksi manual</small>
                    </div>
                ...
                <div class="modal-body px-4 py-4">
                    ...
                    <div class="form-group"
                         x-data="{
                             display: '',
                             init() {
                                 let raw = parseInt($wire.get('nominal')) || 0;
                                 this.display = raw ? raw.toString().replace(/\B(?=(\d{3})+(?!\d))/g, '.') : '';
                                 $wire.$watch('nominal', val => {
                                     let n = parseInt(val) || 0;
                                     this.display = n ? n.toString().replace(/\B(?=(\d{3})+(?!\d))/g, '.') : '';
                                 });
                             },
                             format(e) {
