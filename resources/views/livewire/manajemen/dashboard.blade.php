                    ...
                    @forelse ($displayedTransaksi as $item)
                        @php
                            ...
                            if ($item->tipe === 'cicilan' && !empty($item->pinjaman_id)) {
                                $link = route('manajemen.cicilan.detail', $item->pinjaman_id);
                            } elseif ($item->tipe === 'pinjaman') {
                                $link = $subTipe === 'khusus'
                                    ? route('manajemen.pinjaman.khusus')
                                    : route('manajemen.pinjaman.biasa');
                            } else {
                                $routeMap = [
                                    'wajib'    => route('manajemen.simpanan.wajib'),
                                    'pokok'    => route('manajemen.simpanan.pokok'),
                                    'sukarela' => route('manajemen.simpanan.sukarela'),
                                    'masuk'    => route('manajemen.rekap.index'),
                                    'keluar'   => route('manajemen.rekap.index'),
                                ];
