                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card shadow-sm border-0">
                                <div class="card-body text-center">
                                    ...
                                    {{-- UPLOAD FOTO --}}
                                    <div class="mb-3">
                                        <input type="file" wire:model="foto" id="fotoInputManajemen"
                                            accept="image/*" class="d-none">
                                        @if (!$foto)
                                            <div class="d-flex justify-content-center mb-1">
                                                <button type="button" class="btn btn-sm btn-outline-secondary mr-1"
                                                    onclick="var el=document.getElementById('fotoInputManajemen'); el.removeAttribute('capture'); el.click()">
                                                    <i class="fas fa-images mr-1"></i>Galeri
                                                </button>
                                                <button type="button" class="btn btn-sm btn-outline-secondary"
                                                    onclick="var el=document.getElementById('fotoInputManajemen'); el.setAttribute('capture','environment'); el.click()">
